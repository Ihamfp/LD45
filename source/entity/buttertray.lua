...
local idleImg = love.graphics.newImage("asset/sprite/traine_de_beurre_faible.png") --31x64
local idleImg2 = love.graphics.newImage("asset/sprite/traine_de_beurre_faible2.png") --64x31
	...
	update = function(self, dt)
		...
		if laser then
			if self.currentAnimation == "right" or self.currentAnimation == "left" then
				if self.y+31 < laser.y+laser.height and self.y+31 > laser.y then
					self.remove = true
